pipeline {
    ...
    parameters {
         string(name: 'tomcat-stage', defaultValue: '54.83.183.89', description: 'Staging Server')
         string(name: 'tomcat-prod2', defaultValue: '54.90.192.3', description: 'Production Server')
    }
